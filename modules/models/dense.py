...
def dense_model_gradientReversal(Inputs,nclasses,nregressions,dropoutRate=0.25):
	...
	#set_trace()
	#  Here add e.g. the normal dense stuff from DeepCSV
	x = Dense(100, activation='relu',kernel_initializer='lecun_uniform', name='classifier_dense1')(Inputs[0])
	x = Dropout(dropoutRate)(x)
	x = Dense(100, activation='relu',kernel_initializer='lecun_uniform', name='classifier_dense2')(x)
	x = Dropout(dropoutRate)(x)
	x = Dense(100, activation='relu',kernel_initializer='lecun_uniform', name='classifier_dense3')(x)
	x_mid = Dropout(dropoutRate)(x)
	x = Dense(100, activation='relu',kernel_initializer='lecun_uniform', name='classifier_dense4')(x_mid)
	x = Dropout(dropoutRate)(x)
	x = Dense(100, activation='relu',kernel_initializer='lecun_uniform', name='classifier_dense5')(x)
	predictions = Dense(nclasses, activation='softmax',kernel_initializer='lecun_uniform', name='pred_flavor')(x)
	
	dom_ada = GradientReversal()(x_mid)
	dom_ada = Dense(100, activation='relu', kernel_initializer='lecun_uniform', name='disc_dense1')(dom_ada)
	dom_ada = Dropout(dropoutRate)(dom_ada)
	dom_ada = Dense(100, activation='relu', kernel_initializer='lecun_uniform', name='disc_dense2')(dom_ada)
	dom_ada = Dense(1, activation='sigmoid', kernel_initializer='lecun_uniform', name='pred_domain')(dom_ada)
